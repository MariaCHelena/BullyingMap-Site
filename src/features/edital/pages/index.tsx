...
const EditalPage = () => {
    return<div className="flex flex-col justify-center items-center h-auto gap-16 mx-10 sm:mx-20 md:mx-36">
        <div className='flex flex-col justify-start gap-3'>
            ...
            <p className="text-preto font-medium">Projeto Bullyingmap 2.0 – Gamificação Ativa para o Enfrentamento à Intimidação Sistemática (Bullying) Nas Escolas (Chamada 04/2023 Tech Learning – Vinculada ao Edital 10/2023 – Programa FAPDF Learning da Fundação de Apoio à Pesquisa do Distrito Federal – FAP-DF).</p>
        ...
        <img className='sm:w-2/3 md:w-3/5 lg:w-2/5' src={arvore} alt="Arvore" />
    </div>
}
