...
const EditalPage = () => {
    return<div className="md:relative flex flex-col items-center h-auto gap-16 md:mx-36 mt-5">
        ...
        <img className='md:absolute top-28 -right-28  w-2/3 sm:w-2/3 md:w-56' src={arvore} alt="Arvore" />
    </div>
}
