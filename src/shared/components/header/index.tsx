    ...
    <>
      ...
      <header className="flex w-full mt-2">
        ...
        lg:px-4 2xl:px-80">
          ...
          <li className="block 2md:hidden cursor-pointer">
            <img src={burger} className="h-8" onClick={() => setModalOpen(true)}/>
          </li>
          <li className="flex-start mb-5">
            <img src={logo} className="2md:h-16 h-12 w-full object-cover"/>
          </li>
          <li className="hidden 2md:block">
            <span
              onClick={() => navigate("/BullyingMap-Site")}
          ...
          <li>
            <img src={redeDeApoio} className="2md:h-24 h-12 w-full"/>
          </li>
        </ul>
      </header>
    </>
